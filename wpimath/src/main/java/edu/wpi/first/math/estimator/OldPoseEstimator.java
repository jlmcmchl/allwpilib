 ...
 */
public class OldPoseEstimator<T extends WheelPositions<T>> {
  ...
  private class InterpolationRecord implements Interpolatable<InterpolationRecord> {
    ...
    public boolean equals(Object obj) {
      ...
      if (!(obj instanceof OldPoseEstimator<?>.InterpolationRecord)) {
        return false;
      }
      var record = (OldPoseEstimator<?>.InterpolationRecord) obj;
